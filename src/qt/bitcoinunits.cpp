...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MCASHs"));
    case mBTC: return QString(QObject::tr("Milli-MCASHs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MCASHs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
