...
DESCRIPTION="MCASH - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/MCASH-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "MCASH" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/MCASH-qt.protocol ${PN}.protocol
	fi
}
